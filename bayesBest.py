...
class Bayes_Classifier:
   ...
   def trainForEval(self, train_set, i):
      ...
      for i in train_set:
         ...
         #file_list = nltk.word_tokenize(file_text.decode('utf-8'))
	 tags = nltk.pos_tag(file_list)
	 file_list = [ii[0] for ii in tags if ii[1] != 'PRP' and i[1] != 'DT' ]
   ...
   def train(self):   
      ...
      for i in iFileList:
         ...
         file_text = self.loadFile(i)
         file_list = nltk.word_tokenize(file_text)
	 tags = nltk.pos_tag(file_list)
	 file_list = [ii[0] for ii in tags if ii[1] != 'PRP' and ii[1] != 'DT' ]
         #file_list = ngrams(file_list,2) 
   ...
   def classifyForEval(self, sText, positive_dict, negative_dict):
      ...
      file_list = nltk.word_tokenize(sText.decode('utf-8'))
      tags = nltk.pos_tag(file_list)
      file_list = [ii[0] for ii in tags if ii[1] != 'PRP' ]
   ...
   def classify(self, sText):
      ...
      lTokens = nltk.word_tokenize(sText.decode('utf-8'))
      # lTokens = ngrams(lTokens,2) 
      tags = nltk.pos_tag(lTokens)
      lTokens = [ii[0] for ii in tags if ii[1] != 'PRP' and ii[1] != 'DT']
      P_positive_result = 0
      P_negative_result = 0
